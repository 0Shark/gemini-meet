...
from gemini_meet.core import AudioReader, AudioWriter, VideoReader
from gemini_meet.providers.base import BaseMeetingProvider
from gemini_meet.providers.browser.browser_session import BrowserSession
from gemini_meet.providers.browser.devices.pulse_server import PulseServer
from gemini_meet.providers.browser.devices.virtual_display import VirtualDisplay
from gemini_meet.providers.browser.devices.virtual_microphone import VirtualMicrophone
from gemini_meet.providers.browser.devices.virtual_speaker import VirtualSpeaker
from gemini_meet.providers.browser.platforms import (
    BrowserPlatformController,
    GoogleMeetBrowserPlatformController,
    TeamsBrowserPlatformController,
    ZoomBrowserPlatformController,
)
from gemini_meet.settings import get_settings
...
class BrowserMeetingProvider(BaseMeetingProvider, VideoReader):
    ...
    async def snapshot(self) -> VideoSnapshot:
        ...
        try:
            ...
            logger.exception("Failed to save snapshot locally")
