...
from gemini_meet.utils.datadog import initialize_datadog  # noqa: E402

initialize_datadog()

from gemini_meet.server import mcp  # noqa: E402
from gemini_meet.settings import Settings, set_settings  # noqa: E402
from gemini_meet.utils.logging import configure_logging  # noqa: E402
...
@click.option(
    "--server/--client",
    help="Run gemini_meet as server or client. Default is server without a meeting URL "
    ", client otherwise.",
    default=None,
)
@click.option(
...
@click.option(
    ...
    show_default=True,
    show_envvar=True,
    envvar="GEMINI_MEET_SERVER_HOST",
)
@click.option(
    "-p",
    "--port",
    ...
    show_default=True,
    show_envvar=True,
    envvar="GEMINI_MEET_SERVER_PORT",
)
@click.option(
    "--llm-provider",
    "--model-provider",
...
@click.option(
    ...
    show_envvar=True,
    envvar="GEMINI_MEET_LOGGING_PLAIN",
)
@click.argument(
    "meeting-url",
    default=None,
...
def cli(  # noqa: PLR0913
    ...
    **cli_settings: Any,  # noqa: ANN401
    ...
    """Start gemini_meet MCP server or server + client to join meetings."""
